...
mock_hearing_security_requests = [
    {
        ...
        "datetime_incident": tz_datetime(2025, 7, 18, 14, 5),
        "datetime_created": tz_datetime(2025, 7, 18, 14, 5, 38, 147375),
        "datetime_updated": tz_datetime(2025, 7, 18, 14, 5, 38, 147392),
        "is_normal": True,
        "level": "Red",
        "photo": ""
    },
    {
        ...
        "datetime_incident": tz_datetime(2025, 7, 19, 10, 0),
        "datetime_created": tz_datetime(2025, 7, 19, 10, 1, 10, 500000),
        "datetime_updated": tz_datetime(2025, 7, 19, 10, 1, 10, 500000),
        "is_normal": True,
        "level": "Yellow",
        "photo": ""
    },
    {
        ...
        "committee_hearing_uuid": uuid.uuid4(),
        "description": "Standard security presence. No issues.",
        "datetime_incident": tz_datetime(2025, 7, 10, 10, 0),
        "datetime_created": tz_datetime(2025, 7, 10, 10, 1, 10, 500000),
        "datetime_updated": tz_datetime(2025, 7, 10, 10, 1, 10, 500000),
        "is_normal": True,
        "level": "Green",
        "photo": ""
    },
    {
        ...
        "committee_hearing_uuid": uuid.uuid4(),
        "description": "Staff and Members gathered throughout hearing rooms. Media is present but orderly. USCP is monitoring/posted as requested. Checked in with staff - Appreciative of support. No issues or disruptions expected.",
        "datetime_incident": tz_datetime(2025, 7, 1, 14, 5),
        "datetime_created": tz_datetime(2025, 7, 1, 14, 5, 38, 147375),
        "datetime_updated": tz_datetime(2025, 7, 1, 14, 5, 38, 147392),
        "is_normal": True,
        "level": "Green",
        "photo": ""
    },
