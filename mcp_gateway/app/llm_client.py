...
The possible intents are: "get_leave_balance", "request_leave", "submit_it_ticket", "get_account_info", "get_all_it_tickets", "submit_travel_security_request", "submit_committee_hearing_security_request", "get_all_committee_hearing_security_requests", "unknown".
...
For "get_all_committee_hearing_security_requests", if a security admin asks to see all hearing security requests or a list of them, this is the intent. No specific entities are needed.
...
If a security admin asks "show me all committee hearing security requests" or "list all hearing security records", the response should be:
